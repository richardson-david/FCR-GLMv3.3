...
#*         with subsequent tweaks to annotation in summer 2021 and spring 2022
#*         And more work to update with local met station + new year of data
#*         File currently runs from 2013-05-15 to 2020-12-31 pending 2021 chem
#*         AS WELL AS ONLY USING WEIR (NOT WETLAND)!
#*****************************************************************
